...
describe("PayWayClient", () => {
  ...
  describe("buildTransactionPayload", () => {
    ...
    it("should base64 encode return_deeplink string", () => {
      ...
      const decoded = Buffer.from(
        payload.fields.return_deeplink,
        "base64",
      ).toString();
    ...
    it("should include view_type in fields but NOT in hash", () => {
      ...
      expect(payloadWithViewType.fields.hash).toBe(
        payloadWithoutViewType.fields.hash,
      );
    });
...
-----END PUBLIC KEY-----`;
    ...
    it("should build complete pre-auth with payout payload", () => {
      ...
      expect(payload.hash).toBe(payload.fields.hash);
      expect(payload.url).toBe(
        "https://checkout-sandbox.payway.com.kh/api/merchant-portal/merchant-access/online-transaction/pre-auth-completion-with-payout",
      );
      expect(payload.method).toBe("POST");
    });
    ...
    describe("key normalization", () => {
      ...
      it("should handle public key on single line", () => {
        const singleLineKey =
          "-----BEGIN PUBLIC KEY-----MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDFkGZU8rk1sCCGxeVEdxHYZs8I1ct4N8+TtECjVltAMI/KkYqU77CveVklb+i/VI0nn9QVymldGhZ422gAOBnUY5j0cNFzlzGJawBDt+aLI49xacOtlhEmq62sn4JZqscCegpCi4IYVPk0QT9ypNOp2NJ3WHERcKgSSPtFC7ZTrQIDAQAB-----END PUBLIC KEY-----";
      ...
      it("should throw error for key without BEGIN marker", () => {
        const invalidKey =
          "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDFkGZU8rk1sCCGxeVEdxHYZs8I-----END PUBLIC KEY-----";
      ...
      it("should throw error for key without END marker", () => {
        const invalidKey =
          "-----BEGIN PUBLIC KEY-----MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDFkGZU8rk1sCCGxeVEdxHYZs8I";
